            ...
            <div className="container">
                ...
                {(showAlert && isSuccess && (
                    <div className="alert alert-success d-flex justify-content-between algin-items-center" role="alert">
                        Login success
                        <span role="button" className="text-dark fs-5 fw-bolder" onClick={() => setShowAlert(false)}>
                            &times;
                        </span>
                    </div>
                )) ||
                    (showAlert && !isSuccess && (
                        <div class="alert alert-danger d-flex justify-content-between algin-items-center" role="alert">
                            Login Fail
                            <span
                                role="button"
